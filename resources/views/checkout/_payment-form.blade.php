{!! Form::open(['url' => '/checkout/payment', 'method'=>'post', 'class' => 'form-horizontal']) !!}
    ...
    <div class="form-group {!! $errors->has('bank_name') ? 'has-error' : '' !!}">
      {!! Form::label('bank_name', '', ['class' => 'col-md-4 control-label']) !!}
      <div class="col-md-6">
    ...
    <div class="form-group {!! $errors->has('sender') ? 'has-error' : '' !!}">
      {!! Form::label('sender', 'Sender', ['class' => 'col-md-4 control-label']) !!}
      <div class="col-md-6">
    ...
    <div class="form-group">
        <div class="col-md-6 col-md-offset-4">
            {!! Form::button('<i class="fa fa-lock"></i>  Confirm Payment', array('type' => 'submit', 'class' => 'btn btn-primary')) !!}
        </div>
    </div>
{!! Form::close() !!}
