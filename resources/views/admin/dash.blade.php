...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/system/admin" class="logo">
      ...
      <span class="logo-mini"><b>CAR</b>GO</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>CHAP</b>Chap</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="{{ asset ('avatar4.png')}}" class="img-circle" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-cart-plus"></i><span>Online Bookings</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href=""><i class="fa fa-check"></i>Approved</a></li>
            <li><a href="/shoppings/system/view"><i class="fa fa-circle-o"></i>Pending</a></li>
            <li><a href="#"><i class="fa fa-times"></i>Cancelled</a></li>
          </ul>>
        </li>

        <li class="treeview">
          <a href="#">
            <i class="fa fa-barcode"></i> <span>Track Cargo</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-sitemap"></i> <span>Warehouses</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="/warehouse/add"><i class="fa fa-circle-o"></i>Add Warehouse</a></li>
            <li><a href="/warehouses/view"><i class="fa fa-eye"></i>View Warehouses</a></li>
          </ul>
        </li>

        <li class="treeview">
          <a href="#">
            <i class="fa fa-bar-chart"></i> <span>SMS</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-pencil"></i> CUstomer Communication</a></li>
  ...
  <footer class="main-footer">
    ...
    <script>
      $(".delware").on("submit", function(){
        return confirm("You are about to delete a warehouse, Continue?");
      });
    </script>
    <!-- Bootstrap 3.3.6 -->
